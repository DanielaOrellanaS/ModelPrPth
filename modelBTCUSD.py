...
file_path = r'C:\Users\user\OneDrive\Documentos\Trading\ModelPrPth\ModelAndTest\DataFiles\Data_Entrenamiento_BTCUSD.xlsx'
...
torch.save(model.state_dict(), "Trading_Model/trading_model_BTCUSD.pth")
...
with open("Trading_Model/min_max_BTCUSD.pkl", "wb") as f:
...
# Ruta de salida
output_path = r"C:\Users\user\OneDrive\Documentos\Trading\ModelPrPth\ModelAndTest\DataFiles\Data_Profit_Entrenamiento_BTCUSD.xlsx"
