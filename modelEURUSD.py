...
file_path = r'C:\Users\user\OneDrive\Documentos\Trading\ModelPrPth\ModelAndTest\DataFiles\Datos_Entrenamiento_EURUSD.xlsx'
...
class TradingModel(nn.Module):
    def __init__(self):
        ...
        self.net = nn.Sequential(
            ...
            nn.Linear(64, 32),
            nn.ReLU(),
            nn.Linear(32, 1)  # solo salida profit
        )
...
torch.save(model.state_dict(), "Trading_Model/trading_model_EURUSD.pth")
